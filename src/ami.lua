    ...
    commands = {
        ...
        setup = {
            ...
            action = function(_options, command, args, cli)
                ...
                if _noOptions or _options.app then
                    am.execute_extension("__bir/download-binaries.lua", { contextFailExitCode = EXIT_SETUP_ERROR })
                end
        ...
        validate = {
            ...
            action = function(_options, command, args, cli)
                ...
                -- //TODO: add switches
                ami_assert(proc.EPROC, "BIR node AMI requires extra api - eli.proc.extra", EXIT_MISSING_API)
                ami_assert(fs.EFS, "BIR node AMI requires extra api - eli.fs.extra", EXIT_MISSING_API)
                ...
                log_success("BIR node configuration validated.")
            end
        },
        about = {
